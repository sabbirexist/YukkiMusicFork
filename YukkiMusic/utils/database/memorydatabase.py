...
HighQualityAudio = lambda: AudioQuality.STUDIO
MediumQualityAudio = lambda: AudioQuality.HIGH
LowQualityAudio = lambda: AudioQuality.LOW
HighQualityVideo = lambda: VideoQuality.FHD_1080p
MediumQualityVideo = lambda: VideoQuality.SD_480p
LowQualityVideo = lambda: VideoQuality.SD_360p
